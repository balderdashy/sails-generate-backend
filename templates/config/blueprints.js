...
module.exports.blueprints = {
   ...
   * `autoWatch`
   *
   * There are no publicCreate events fired on the socket for new instances
   * unless autoWatch is set to true. Default is autoWatch: false
   *
   * Alternatively you have to call .watch explicitly:
   * https://github.com/balderdashy/sails-docs/blob/master/reference/ModelMethods.md#watchrequest
   */
  autoWatch: false,
